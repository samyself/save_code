...
from model.model_ac_pid_out_PID import *
...
def my_args():
    ...
    # 预训练模型路径
    parser.add_argument('--pretrain_ckpt_path', default='./data/ckpt/ac_1024_v1.pth', type=str, help='')
    # 模型保存路径
    parser.add_argument('--saved_ckpt_path', default='data/ckpt/ac_1024_v1.pth', type=str, help='')
    ...
    # 保存图片路径
    parser.add_argument('--result_pic_folder', default='./data/train_result/pic/ac_1024_v1', type=str, help='')
    # 训练时自动保存的测试损失
    parser.add_argument('--best_loss', default=158.5880, type=int, help='')
            ...
            for split_index in range(split_num):
                ...
                for i in range(split_len):
                    if i % 30 == 0:
                        ...
                        split_input[i, 0] = pred_output[i-1].detach()
        ...
        for batch in tqdm(eval_loader):
            ...
            for split_index in range(split_num):
                ...
                for i in range(split_len):
                    ...
                    # pred_output[i] = net.last_ac_pid_out_hp
                    # pred_output[i] = net(split_input[i])
