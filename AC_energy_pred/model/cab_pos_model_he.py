...
class MyCabPosModel(nn.Module):
    def __init__(self, input_size=6, output_size=1, hidden_size1=None, hidden_size2=None, dropout=0.2):
        ...
        self.cab_pos_part2 = MLP(input_size=1, hidden_sizes=[64, 32], output_size=1, use_batchnorm=True)
...
class MyModel(nn.Module):
    ...
    def forward(self, x):
        ...
        if not self.training:
            ...
            # 限定最小值为com_speed_min
            compressor_speed = torch.relu(compressor_speed - com_speed_min) + com_speed_min
            # 限定最大值为8000
            compressor_speed = 8000 - torch.relu(8000 - compressor_speed)
