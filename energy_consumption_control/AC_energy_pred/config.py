...
VAR_NAMES = [
                ...
                'Blower_Fr_PWM',
                'CFan_PWM',
                'sTmSigIn_I_FrntBlowerLoPwrI',
                'sTmSigIn_U_FrntBlowerLoPwrU',
                'sTmSigIn_I_FanLoPwrI',
                'sTmSigIn_U_FanLoPwrU',
                ...
                'TmRteOut_HvBattInletCooltT',  # 进电池前，和空调换热后电池冷却液温度
                'TmRteOut_HvBattOutletCooltT',  # 进电池后，和空调换热前电池冷却液温度

                'Pump_Bat_PWM_Req',  # 电池水泵占空比
                'WT_Mode_9Way',  # 电池水泵模式

                'TmRteOut_HvchPwrCns',  # 加热器功率
                'sTmSigIn_Te_HvchOutCooltT',  # 乘员舱制热时冷媒出水口温度，被加热后的温度和空调换热前电池冷却液温度
                'sTmSigIn_Te_HvchInCooltT',  # 乘员舱制热时冷媒进水口温度，被加热前的温度
