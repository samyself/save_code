...
def my_args():
    ...
    # 训练数据路径
    parser.add_argument('--train_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_acpidout_train_normal1016.pkl', type=str, help='')
    # 评测数据路径
    parser.add_argument('--eval_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_acpidout_eval_normal1016.pkl', type=str, help='')
    # 总体据路径
    parser.add_argument('--all_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_acpidout_all_normal.pkl', type=str, help='')
    ...
    # 预训练模型路径
    parser.add_argument('--pretrain_ckpt_path', default='./data/ckpt/ac_1016_v2.pth', type=str, help='')
    # 模型保存路径
    parser.add_argument('--saved_ckpt_path', default='data/ckpt/ac_1016_v2.pth', type=str, help='')
    ...
    # 保存图片路径
    parser.add_argument('--result_pic_folder', default='./data/train_result/pic/ac_1016_v2', type=str, help='')
    # 训练时自动保存的测试损失
    parser.add_argument('--best_loss', default=501, type=int, help='')
    ...
    with torch.no_grad():
        ...
        for batch in tqdm(eval_loader):
            ...
            for split_index in range(split_num):
                ...
                ac_pid_out_r_list.append(torch.tensor(ac_pid_out_r))
...
if __name__ == '__main__':
    ...
    data_folder = 'D:/Code/code/submit/energy_consumption_control/AC_energy_pred/data/energy_cunsum_data/csv_file'
    ...
    # input_list_save_path = 'data/cs_1017/input_data'
    # input_raw_save_path = 'data/cs_1017/input_raw'
    # output_save_path = 'data/cs_1017/output_data'
