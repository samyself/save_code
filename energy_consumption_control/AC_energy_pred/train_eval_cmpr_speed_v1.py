...
from model.model_cmpr_control_gai import *
...
def my_args():
    ...
    # 训练数据路径
    parser.add_argument('--train_dataset_path', default='./data/energy_cunsum_pkl/cmpr_control_train_dataset_full_seed2_up800.pkl', type=str, help='')
    # 评测数据路径
    parser.add_argument('--eval_dataset_path', default='./data/cmpr_control_eval_dataset_full_seed2_up800.pkl', type=str, help='')
    # 总体据路径
    parser.add_argument('--all_dataset_path', default='./data/cmpr_control_all_dataset_full_seed2_up800.pkl', type=str, help='')
    ...
    # 预训练模型路径
    parser.add_argument('--pretrain_ckpt_path', default='./data/ckpt/cc_1010_sub2_up800.pth', type=str, help='')
    # 模型保存路径
    parser.add_argument('--saved_ckpt_path', default='data/ckpt/cc_1010_sub2_up800.pth', type=str, help='')
    ...
    # 保存图片路径
    parser.add_argument('--result_pic_folder', default='./data/train_result/pic/submits1010_v2_up800', type=str, help='')
    # 训练时自动保存的测试损失
    parser.add_argument('--best_loss', default=450, type=int, help='')
