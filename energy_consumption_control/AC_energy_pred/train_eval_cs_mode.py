...
def my_args():
    ...
    # 总体据路径
    parser.add_argument('--all_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_comsped_all_normal1016.pkl', type=str, help='')
    ...
    # 训练时自动保存的测试损失
    parser.add_argument('--best_loss', default=378, type=int, help='')
