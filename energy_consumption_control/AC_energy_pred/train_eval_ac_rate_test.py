...
from dataset.dataset_ackprate import AcPidOutBaseDataset
from draw_pic import draw_pred
# from model.model_cmpr_control_tcn import *
from model.model_ac_kprate_lemans import *
...
def my_args():
    ...
    # 训练数据路径
    parser.add_argument('--train_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_ackprate_train_normal1016.pkl', type=str, help='')
    # 评测数据路径
    parser.add_argument('--eval_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_ackprate_eval_normal1016.pkl', type=str, help='')
    # 总体据路径
    parser.add_argument('--all_dataset_path', default='./data/energy_cunsum_data/pkl_file/acc_pid_out/seed2_ackprate_all_normal1016.pkl', type=str, help='')
    ...
    # 预训练模型路径
    parser.add_argument('--pretrain_ckpt_path', default='./data/ckpt/ak_20250208_v1.pth', type=str, help='')
    # 模型保存路径
    parser.add_argument('--saved_ckpt_path', default='data/ckpt/ak_20250208_v1.pth', type=str, help='')
    ...
    # 保存图片路径
    parser.add_argument('--result_pic_folder', default='./data/train_result/pic/ak_20250208_v1', type=str, help='')
    # 训练时自动保存的测试损失
    parser.add_argument('--best_loss', default=0.0798, type=int, help='')
...
if __name__ == '__main__':
    ...
    data_folder = 'D:/Code/code/submit/eng_test/energy_consumption_control/AC_energy_pred/data/pre_filter/csv_lemans_all'
