...
class MyModel(nn.Module):
    def __init__(self, input_size=6, hidden_size1=256, hidden_size2=64, num_layers1=4, num_layers2=4, output_size=1):
        ...
        # 输出层
        self.fc = nn.Sequential(nn.Linear(hidden_size2, 64),
                                nn.BatchNorm1d(64),
                                nn.ReLU(),
                                nn.Linear(64, 16),
                                nn.BatchNorm1d(16),
        ...
        # 批归一化层
        self.bn = nn.BatchNorm1d(input_size,eps=1e-5, momentum=0.1)
