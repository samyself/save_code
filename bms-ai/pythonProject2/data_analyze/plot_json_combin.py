...
# 使用示例
file_path = '../../data/json_res/analyze_info_Soc_0102_lstm_tcn_v1_3_delta_all.json'  # 替换为你的文件路径
data = parse_json_arrays_from_file(file_path)

file_path1 = '../../data/json_res/analyze_info_Soc_0102_lstm_v1_2_delta_all.json'  # 替换为你的文件路径
data1 = parse_json_arrays_from_file(file_path1)
...
for i in range(len(data)):
    json = data[i]
    json1 = data1[i]
    if '90.0_100.0' in json1['file_info']:
        if json1['Soc_pr_max'] >= 3.0:
            ...
            num90_100 += 1
            print(json1['file_info'])
        if json1['Soc_pr_max'] >= 2.0:
            # download_name = json['file_info'].replace('_90.0_100.0','')
            # base_fold = 'D:/Code/code/submit/bms_ai/PycharmProjects/data/pic/Soc_1204_lstm_v5k_90.0_100.0'
            # input_path = f'{base_fold}/{download_name}.png'
